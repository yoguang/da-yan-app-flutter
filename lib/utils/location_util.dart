...
class LocationUtil {
  factory LocationUtil() => _singleton ??= LocationUtil._();
  LocationUtil._();
  static LocationUtil? _singleton;
  ...
  // 格式化距离
  // 返回 Map {'value': 0, 'text': ''}
  static Map<String, dynamic> formattedDistance(latLng1, latLng2) {
    if (latLng1 == null ||
    ...
    return {
      'value': distanceNum,
      'text': '${distanceNum.toStringAsFixed(2)}公里'
    };
  }
}
